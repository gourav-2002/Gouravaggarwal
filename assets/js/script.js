	...
	var Taeled = {
		...
		Basic: {
			...
			BackgroundImage: function (){
				...
				$('[data-background-terms]').each(function() {
					$(this).css('background-image', 'url('+ $(this).attr('data-background-terms') + ')');
				});

				$('[data-background-center').each(function() {
					$(this).css('background-image', 'url('+ $(this).attr('data-background-center') + ')');
				});
				$('[data-background-backend]').each(function() {
					$(this).css('background-image', 'url('+ $(this).attr('data-background-backend') + ')');
				});
			},
			Animation: function (){
				if($('.wow').length){
